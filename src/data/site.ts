...
export const aboutContent = {
  ...
  intro:
    "We are Mohifar Jahan Trading and Contracting, a leading Trading, Engineering and Contracting Firm in Bahrain, specializing in various construction, engineering, design, and industrial maintenance services and its material supply. Our methodology combines advanced technology with innovative design, ensuring efficient and high-quality project delivery. We are dedicated to excellence, demonstrated by our capacity to manage diverse and complex projects with precision and skill. Our extensive portfolio features state-of-the-art interior and exterior design, dependable equipment rental, and premium material supply. We aim to surpass client expectations, building long-lasting relationships founded on trust and outstanding performance. MJTC transforms visions into reality through unmatched engineering expertise, experience, and a commitment to client satisfaction.",
